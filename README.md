...
# okay wait sir i tested them on some image in my test images.Then what about the images that my network didn't see??So i tried my model to cross-validate on image that is not in training or test set.
